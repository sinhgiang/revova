...
// A real, rasterized (AVIF/WebP) in-body image — generated by
// scripts/gen-blog-images.mjs, not a stock photo or placeholder. `file` is the
// path under /public without extension, e.g. "/blog/chargebee-dunning-img-1".
export function InBodyImage({ file, alt, caption, width = 1200, height = 600 }: {
  file: string
  alt: string
  caption?: string
  width?: number
