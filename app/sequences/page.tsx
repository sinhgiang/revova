...
import { Mail, Clock, CheckCircle, Zap } from 'lucide-react'
...
const sequence = [
  ...
  },
  {
    ...
    subject: 'Final reminder — your account is about to be paused',
    description: 'Final nudge with urgency. Creates FOMO around losing access to their subscription.',
    color: 'rose',
  },
]
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8 max-w-4xl">
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-1">Automated 3-email recovery sequence — runs on autopilot</p>
          </div>
          ...
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-gray-400 text-sm">All 3 emails are enabled and running automatically</span>
          </div>
                  ...
                  <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 flex gap-5">
                    ...
                    <div className={`w-10 h-10 rounded-xl ${c.bg} flex items-center justify-center flex-shrink-0`}>
                      {step.step === 1 ? <Zap className={`w-5 h-5 ${c.text}`} /> :
                       step.step === 2 ? <Clock className={`w-5 h-5 ${c.text}`} /> :
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="font-semibold text-gray-900 mt-2">
                        Subject: &ldquo;{step.subject}&rdquo;
                      </p>
